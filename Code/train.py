...
from ligandpocket_FBDD import LigandPocketFBDD
...
if __name__ == "__main__":
    ...
    info = trainer.fit(model=pl_module, ckpt_path=ckpt_path)
    #trainer.logger.plot(info['loss'])
    #trainer.logger.save_fig('train_loss')
    # # run test set
